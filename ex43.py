"""
   @Author:ShiLiNa
   @Brief:The exercise43 for Learn python the hard way
   @CreatedTime:20/10/2016
"""
...
class LaserWeaponArmory(Scene):
    ...
    def enter(self):
        ...
        if guess == code:
            ...
            print "The look buzzes one last time and then you hear a sickening"
...
class TheBridge(Scene):
    ...
    def enter(self):
        ...
        if action == "throw the bomb":
            ...
            print "the bomb. You die you see another Gothon frantically try to disarm"
            print "it goes off."
            return 'death'
